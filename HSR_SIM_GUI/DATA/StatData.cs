...
namespace HSR_SIM_GUI.Data
{
    internal static class StatData
    {
        ...
        public static Dictionary<string, string> subStatsUpgrades = new Dictionary<string, string>()
        {
            { "spd_fix", "2,3" }
            ,{ "hp_fix", "38,103755" }
            ,{ "atk_fix", "19,051877" }
        ...
        public static Dictionary<string, string> mainStatsUpgrades = new Dictionary<string, string>()
        {
            { "spd_fix", "1,4" }
            ,{ "hp_fix", "39,5136" }
            ,{ "atk_fix", "19,7568" }
        ...
        public static Dictionary<string, string> mainStatsBase = new Dictionary<string, string>()
        {
            { "spd_fix", "4,032" }
            ,{ "hp_fix", "112,896" }
            ,{ "atk_fix", "56,448" }
